...
const repertorioMissaFev = [
  {
    ...
    id: sumId(),
    categoria: 'Entrada',
    link: 'https://www.youtube.com/watch?v=JgSAFw91aWA',
    base: true,
    cifra: `
    Intro: D A EM G A7
  ...
  {
    titulo: 'Ó Trindade Vos Louvamos',
    id: sumId(),
    categoria: 'Comunhao',
    link: 'https://www.youtube.com/watch?v=Wt1IizlpSFc',
    base: true,
    cifra: `
  ...
  {
    titulo: 'Deus é bom e fiel',
    id: sumId(),
    categoria: 'Final',
    link: 'https://www.youtube.com/watch?v=uwNKEW4TbyY',
    base: true,
    cifra: `
    Tom: G
