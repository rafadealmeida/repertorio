...
const repertorioMissaFev24Pedro = [
  {
    titulo: 'Fala Senhor',
    id: sumId(),
    categoria: 'Entrada',
    ...
    G               D    G          Em
    Preciso estar atento  a todo movimento do Céu
    G               A9
    Em direção a mim
  ...
  // },
  {
    titulo: 'Salmo 115',
    id: sumId(),
    link: 'https://www.youtube.com/watch?v=Pm8goYvowo8',
    base: false,
    categoria: 'Salmo',
    cifra: `
            E        B/D#      C#m7 C#m7/B
  ...
  },
  {
    ...
    Dm
    Numa nuvem resplendente
    Am                       Dm
    fez-se ouvir a voz do Pai:
    Dm                     G
  ...
  },
  {
    ...
    O Teu Sangue Em Meu Sangue, Senhor
              G     G/B        C C9  G/B  Am7
    E Estando Unido a  Ti, Esquecer-Me  De   Mim
      D4                  D            Em7/9  C9   Em7/9  C9

    `,
  },
  {
    titulo: 'Yeshua - Teclado',
    id: sumId(),
    categoria: 'Gracas',
    cifra: `
    G#m
...
export default repertorioMissaFev24Pedro;
