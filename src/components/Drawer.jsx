...
export default function TemporaryDrawer() {
  ...
  const list = (anchor) => (
    ...
    >
      ...
      <List>
        <LinkStyled href="/missaMar24Judas" className="menu__link">
          <ListItem key="Missa" disablePadding>
            <ListItemButton>
              <ListItemIcon>
                <Icon icon={crossOutline} fontSize={30} />
              </ListItemIcon>
              <ListItemText primary="Missa Março 2024 São Judas" sx={{ textDecoration: 'none', color: 'black' }} />
            </ListItemButton>
          </ListItem>
        </LinkStyled>
      </List>
      <List>
        <LinkStyled href="/MissaMar24Imac" className="menu__link">
          <ListItem key="Missa" disablePadding>
            <ListItemButton>
              <ListItemIcon>
                <Icon icon={crossOutline} fontSize={30} />
              </ListItemIcon>
              <ListItemText primary="Missa Março 2024 Imaculada" sx={{ textDecoration: 'none', color: 'black' }} />
            </ListItemButton>
          </ListItem>
        </LinkStyled>
      </List>
